  ...
  return (
    <section>
      ...
      <div className="flex gap-4 mb-8">
        <button className="bg-blue-500 text-white px-6 py-3 rounded-lg">Start Translation</button>
        <div className="flex-1 bg-white rounded-lg px-6 py-3">
          Translation Progress: 100%
        </div>
        <button className="bg-blue-600 text-white px-6 py-3 rounded-lg">Continue to Review</button>
      </div>
      ...
      <div className="grid grid-cols-2 gap-8">
        ...
        <div>
          ...
          <div className="bg-white rounded-xl shadow min-h-[420px] p-6" dir="rtl">
